...
public class VMSResponse implements Serializable{
     ...
     */
    public void setResponseBodyResult(String result){
        this.responseContent.put(VMSResponse.RESPONSE_RESULT,result);
    }
     ...
     */
    public void setResponseBodyMsg(String msg){
        this.responseContent.put(VMSResponse.RESPONSE_MSG,msg);
    }
     ...
     */
    public void setResponseBodyData(Object data){
        this.responseContent.put(VMSResponse.RESPONSE_DATA,data);
    }
     ...
     * @param total 携带数据的数量
     */
    public void setResponseBodyTotal(long total){
        this.responseContent.put(VMSResponse.RESPONSE_TOTAL,total);
    }
